...
export const JournalsList = styled.div<{ $nested?: boolean }>`
    /* padding-left: ${props => props.$nested ? '0px' : '0'}; */
`;
...
export const JournalItemHeader = styled.div`
    display: flex;
    align-items: center;
    gap: 8px;
`;
...
export const JournalSubtitle = styled.div`
    font-size: 11px;
    opacity: 0.6;
    padding-left: 22px;
    overflow: hidden;
...
export const JournalContent = styled.div<{ $sidebarCollapsed: boolean }>`
    flex: 1;
    display: flex;
    flex-direction: column;
    overflow: hidden;
